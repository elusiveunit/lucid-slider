...
/*===========================================================================*\
      =MODIFIED, REMEMBER IF UPDATING
\*===========================================================================*\

The JavaScript in _global_head() is modified slightly:

- Before >   if (confirm('This action can not be undone, are you sure?'))
- After  >   if (confirm(<?php _e( "'This action can not be undone, are you sure?'", 'lucid-slider' ); ?>))
		...
		jQuery(function($)
		{
			...
			{		
				...
				if (elem.attr('class') && elem.filter('[class*=dodelete]').length)
				{
					...
					if (confirm(<?php _e( "'This action can not be undone, are you sure?'", 'lucid-slider' ); ?>))
					{
						if (the_name)
						{
